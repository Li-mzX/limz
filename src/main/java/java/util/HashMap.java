 ...
 */
    ...
    /**
     * 下一次大小调整后的大小 容量*负载因子    capacity * loadfactor
     */
    int threshold;
    ...
    /**
     * 替换给定哈希索引中的所有链表节点，除非表太小，在这种情况下，调整大小。
     */
    ...
    */
    static final class TreeNode<K,V> extends LinkedHashMap.Entry<K,V> {
        ...
        /**
         * 确保给定的根是其bin的第一个节点。使用给定的哈希和键查找从根p开始的节点。kc参数在首次使用比较键时缓存comparableClassFor(键)。
         */
