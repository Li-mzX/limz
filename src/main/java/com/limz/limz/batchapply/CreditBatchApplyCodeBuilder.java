...
public class CreditBatchApplyCodeBuilder {
    ...
    public CreditApplyParameter runGetParams(String countryCode) {
        ...
        if ("NULL".equals(propertySerialNo)) {
            throw new CreditBatchApplyException("����" + countryCode + " ������ȡʧ�ܣ�");
        }
        try {
            ...
            e.printStackTrace();
            throw new CreditBatchApplyException("ί�е��Ż�ȡʧ�ܣ�" + e.getMessage());
        }
        try {
            ...
            e.printStackTrace();
            throw new CreditBatchApplyException("��������Ż�ȡʧ�ܣ�" + e.getMessage());
        }
        Date srDate = null;
        try {
